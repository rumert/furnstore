  ...
  return (
    <div className='w-[90%] max-w-[600px] mx-auto'>
      <div className='h-10 mx-4 border rounded-3xl overflow-hidden flex'>
        <input type="text" placeholder='Search Products' className='w-full h-full px-4 text-black text-sm md:text-xl border-gray-500 rounded-3xl focus:border-2 focus:border-gray-500 focus:rounded-3xl outline-none'/>
