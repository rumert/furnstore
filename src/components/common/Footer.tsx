...
function Footer() {
  return (
    <div className='h-screen md:h-auto pt-12 pb-32 md:pb-48 bg-gradient-to-b md:bg-gradient-to-r from-[#2c2c2c] to-[#1a1a1a] text-white md:text-xl md:grid-cols-4 md:max-h-[75vh]'>
