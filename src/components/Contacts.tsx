...
function Contacts() {
  ...
  return (
    <div className='text-white grow flex flex-col bg-gradient-to-r from-[#2c2c2c] to-[#1a1a1a] py-24'>
        <div className='grow flex justify-evenly'>
            ...
            <div className='before:block before:pt-[100%] box-border m-7 rounded-3xl md:rounded-[4rem] overflow-hidden xl:m-5 w-[calc(50%_-_56px)] xl:w-[calc(33%_-_40px)] 2xl:w-[calc(25%_-_40px)] relative border'>
                <div className='absolute top-10 left-0 bottom-0 right-0 h-[70%] flex flex-col'>
                    <button onClick={() => handleFaqIsActive(0)} className='w-full border grow'>FAQ1</button>
                    {faqIsActive[0] && <div >Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                        sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>}
                    <button onClick={() => handleFaqIsActive(1)} className='w-full border grow'>FAQ2</button>
                    {faqIsActive[1] && <div >Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                        sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>}
                    <button onClick={() => handleFaqIsActive(2)} className='w-full border grow'>FAQ3</button>
                    {faqIsActive[2] && <div >Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                        sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>}
                    {!faqIsActive[0] && !faqIsActive[1] && !faqIsActive[2] && <button onClick={() => handleFaqIsActive(3)} className='w-full border grow'>FAQ4</button>}
                    {faqIsActive[3] && <div >Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                        sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>}
                </div>
            </div>
        </div>
        <div className='grow h-[25%] flex justify-center items-center text-4xl'>
